    ...
    <div class="container">
      ...
      <div class="grid">
        <?php array_map(function ($item) use ($in_cart) { ?>
          <div class="grid-item border <?= htmlentities($item["item_brand"]) ?? "Brand" ?>">
            <div class="item py-2" style="width: 200px;">
              <div class="product font-rale">
                <a href="<?php printf('%s?id=%s', 'product.php', $item['item_id']); ?>"><img src="<?= htmlentities($item["item_image"]) ?? "./assets/products/13.png" ?>" alt="product1" class="img-fluid"></a>
                <div class="text-center">
                  <h6><?= htmlentities($item["item_name"]) ?? "Unknown" ?></h6>
